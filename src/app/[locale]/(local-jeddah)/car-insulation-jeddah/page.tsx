    ...
    <>
      ...
      <section aria-labelledby="further-reading-car" style={{ maxWidth: '900px', margin: '3rem auto 0', padding: '0 1.5rem' }}>
        ...
        <ul style={{ display: 'grid', gap: '0.75rem', listStyle: 'none', padding: 0, margin: 0 }}>
          <li><Link href={localePath(locale as Locale, '/blog/complete-guide-car-tinting-jeddah')} style={{ color: 'var(--primary)', fontWeight: 600, textDecoration: 'none' }}>{isAr ? 'الدليل الكامل لتظليل السيارات في جدة 2026 ←' : 'The Complete Guide to Car Tinting in Jeddah 2026 ←'}</Link></li>
          <li><Link href={localePath(locale as Locale, '/blog/car-protection-tinting-vs-ceramic-vs-ppf')} style={{ color: 'var(--primary)', fontWeight: 600, textDecoration: 'none' }}>{isAr ? 'تظليل أم نانو سيراميك أم PPF؟ دليل القرار ←' : 'Tinting vs Ceramic vs PPF — Decision Guide ←'}</Link></li>
