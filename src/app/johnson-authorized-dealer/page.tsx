...
import { SITE_URL, SITE_NAME, WHATSAPP_LINK, PHONE, OWNER_NAME, OWNER_TITLE, CRN, VAT_ID } from '@/lib/constants';
    ...
    <>
      ...
      <section className={styles.hero}>
        <div className={styles.heroBg}>
          <Image src="/images/hero-car-tinting-jeddah.webp" alt="تظليل جونسون Supreme IR على سيارة في جدة" fill priority style={{ objectFit: 'cover' }} />
