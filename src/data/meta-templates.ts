...
export const metaTemplates = {
  ...
  home: {
    ...
    description: "تظليل سيارات بفيلم نانو سيراميك يحجب 97% من الحرارة + عزل زجاج مباني في كل المملكة. ضمان عمر السيارة. احجز موعدك الآن.",
    h1: "تظليل سيارات وعزل حراري في جدة — نانو سيراميك بضمان عمر السيارة",
  },
  ...
  serviceHub: {
    ...
    examples: {
      carTinting: {
        title: "تظليل سيارات جدة — نانو سيراميك بضمان عمر السيارة | AzelCore (2026)",
        description: "تظليل سيارات احترافي في جدة بأفلام نانو سيراميك بنسبة حجب 97% IR. أسعار تبدأ من 800 ر.س. ضمان عمر السيارة. احجز عبر واتساب.",
  ...
  districtPage: {
    ...
    descriptionTemplate: "أفضل تظليل سيارات في حي {district} بجدة. {climateNote}. نانو سيراميك بضمان عمر السيارة. خدمة متنقلة متاحة.",
