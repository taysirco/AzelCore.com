...
export const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer: "لأن النانو سيراميك يحجب 97% من الأشعة تحت الحمراء (IR) و99% من الأشعة فوق البنفسجية (UV) ويدوم حتى 10 سنوات دون أن يبهت لونه، بينما التظليل العادي يحجب 30% فقط ويتحول للون البنفسجي خلال 6 أشهر في شمس جدة.",
